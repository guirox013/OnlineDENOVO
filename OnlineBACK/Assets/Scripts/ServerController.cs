...
public class ServerControlador : MonoBehaviour
{
	...
	void Awake()
	{
		...
		if (!PhotonNetwork.connected)
			PhotonNetwork.ConnectUsingSettings("Teste Guibas"); // version of the game/demo. used to separate older clients from newer ones (e.g. if incompatible)
